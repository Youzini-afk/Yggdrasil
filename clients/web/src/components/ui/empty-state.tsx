...
export function EmptyState({ icon, title, body, action, className }: EmptyStateProps) {
  return (
    <div
      className={cn(
        "mx-auto flex w-full max-w-[40ch] flex-col items-center gap-4 rounded-[20px] border border-dashed border-whisper-border-strong/70 bg-transparent px-8 py-14 text-center md:max-w-[52ch]",
        className,
      )}
    >
