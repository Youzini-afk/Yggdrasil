...
- [`KERNEL_V1_CONTRACT.md`](KERNEL_V1_CONTRACT.md) — kernel v1 公开契约：58 个方法、45 个事件、能力句柄、Path A / Path B、SDK 与 conformance
...
- [`v1/schemas/`](v1/schemas/) — 110 个 JSON Schema（methods / events / top-level），SDK 的单一可信源
