...
- [`CONTRACT_LAYERING_MATRIX.md`](CONTRACT_LAYERING_MATRIX.en.md) — candidate v2 layering matrix for all 80 methods, 59 events, and 8 top-level schemas; it does not change current v1 status
...
- [`v1/schemas/`](v1/schemas/) — 147 JSON Schemas (methods / events / top-level), the SDK source of truth
