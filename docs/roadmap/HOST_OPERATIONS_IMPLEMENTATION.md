...
| Phase 4 | 进行中 | identity/observation 与 typed-worker 切片已实现：durable enrollment/heartbeat/revoke、MAC-bound operation authority、Host/Agent 双 ledger、授权 artifact stream、声明式 verifier 和原生 `ygg target-agent`；driver/deployment/tunnel 待后续切片 |
