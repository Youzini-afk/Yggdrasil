...
性能与代码健康指南见 [`docs/performance/PERFORMANCE_AND_CODE_HEALTH.md`](docs/performance/PERFORMANCE_AND_CODE_HEALTH.md)；当前外部项目操作平面计划见 [`docs/roadmap/EXTERNAL_PROJECT_OPERATING_PLANE_ALPHA.md`](docs/roadmap/EXTERNAL_PROJECT_OPERATING_PLANE_ALPHA.md)；后续阶段见 [`docs/roadmap/NEXT_STEPS.md`](docs/roadmap/NEXT_STEPS.md)。
