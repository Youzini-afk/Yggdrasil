...
## External Project Operating Plane Alpha (in progress)
...
- **E0 — Plan, Research, ADR**: add the bilingual temporary plan, save external evidence, and switch the current headline.
- **E1 — Project Intake Lab**: `official/project-intake-lab`, no-execution project classification, stack detection, workspace plan, risk summary, candidate entrypoints, and adapter plan.
