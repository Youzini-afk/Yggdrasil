...
- [`KERNEL_V1_CONTRACT.md`](KERNEL_V1_CONTRACT.en.md) — kernel v1 public contract: 63 methods, 45 events, capability handles, Path A / Path B, SDKs, and conformance
...
- [`v1/schemas/`](v1/schemas/) — 115 JSON Schemas (methods / events / top-level), the SDK source of truth
