...
- 371 个具名 conformance 用例 + crate / service 单元测试，全部通过；110 个 v1 schema（58 methods + 45 events + 7 top-level）可验证。
...
- 公开 HTTPS git 安装通道：`kernel.v1.outbound.git_fetch`、profile 级 lockfile、`official/package-installer-lab`。
- 通用的流式与取消生命周期。
