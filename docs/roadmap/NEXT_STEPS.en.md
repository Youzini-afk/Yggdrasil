...
- Contract V1 is the public platform spec; all 153 schemas (80 methods + 59 events + 14 top-level) validate, and 461 conformance cases pass.
- The first five layering-migration steps are complete: v1 factual-drift repair, the Experimental Contract Registry with explicit negotiation, 36 owner-namespace canonical/legacy dual stacks, the SHA-256 object/artifact foundation, and EffectReceipt / Change primitives. The next step in [`CONTRACT_V2_MIGRATION.md`](CONTRACT_V2_MIGRATION.en.md) establishes Protocol Commons descriptor scaffolding.
