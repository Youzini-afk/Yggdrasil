...
- Top-level schemas: `docs/spec/v1/schemas/*.schema.json` (15), including the additive Protocol Commons descriptor.
- Error codes: [`v1/ERROR_CODES.md`](v1/ERROR_CODES.en.md).
- Event registry: [`v1/EVENT_KIND_REGISTRY.md`](v1/EVENT_KIND_REGISTRY.en.md).

All 154 schemas must pass `cargo run -p ygg-cli --bin validate-schemas`.
...
3. 15 top-level schemas validate.
