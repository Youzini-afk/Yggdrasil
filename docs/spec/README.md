...
- [`CONTRACT_LAYERING_MATRIX.md`](CONTRACT_LAYERING_MATRIX.md) — 候选 v2 分层矩阵：逐项归类 80 个方法、59 个事件与 8 个顶层 schema；不改变 v1 现行状态
...
- [`v1/schemas/`](v1/schemas/) — 147 个 JSON Schema（methods / events / top-level），SDK 的单一可信源
