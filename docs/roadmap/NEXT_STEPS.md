...
- Experience-Led Platform Beta：长期方向；长期设计见 [`docs/product/EXPERIENCE_LED_PLATFORM_BETA.md`](../product/EXPERIENCE_LED_PLATFORM_BETA.md)。Experience Beta 0–6、Performance & Code Health Beta、External Project Operating Plane Alpha、Storage Backend Neutrality Alpha 已完成。Storage 指南见 [`docs/guides/STORAGE_BACKEND_NEUTRALITY.md`](../guides/STORAGE_BACKEND_NEUTRALITY.md)。后续真正扩展 PostgreSQL/TDB/检索后端前，应继续保持 storage contract backend-neutral。
