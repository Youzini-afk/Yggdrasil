...
export interface KernelMethods {
  ...
  projectList(params: ProjectListParams): Promise<ProjectListResult>;
  projectStart(params: ProjectIdParams): Promise<ProjectTransitionResult>;
  projectStatus(params: ProjectIdParams): Promise<ProjectStatusResult>;
  projectStop(params: ProjectIdParams): Promise<ProjectTransitionResult>;
  ...
  proposalApprove(params: ProposalDecisionParams): Promise<ProposalRecord2>;
  proposalCreate(params: ProposalRecord3): Promise<ProposalRecord4>;
  proposalGet(params: ProposalIdParams): Promise<ProposalRecord5>;
  proposalList(params: EmptyParams): Promise<ProposalListResult>;
  proposalReject(params: ProposalDecisionParams): Promise<ProposalRecord6>;
  ...
  sessionGet(params: EmptyParams): Promise<SessionGetResult>;
...
export async function projectList(
  ...
  return this.transport.invoke("kernel.v1.project.list", params) as Promise<ProjectListResult>;
}
...
export async function projectStart(
  ...
  return this.transport.invoke("kernel.v1.project.start", params) as Promise<ProjectTransitionResult>;
}
...
export async function projectStop(
  ...
  return this.transport.invoke("kernel.v1.project.stop", params) as Promise<ProjectTransitionResult>;
}
...
): Promise<ProposalRecord2> {
  return this.transport.invoke("kernel.v1.proposal.approve", params) as Promise<ProposalRecord2>;
}

export async function proposalCreate(
  this: KernelClient,
  params: ProposalRecord3,
): Promise<ProposalRecord4> {
  return this.transport.invoke("kernel.v1.proposal.create", params) as Promise<ProposalRecord4>;
}

export async function proposalGet(
  this: KernelClient,
  params: ProposalIdParams,
): Promise<ProposalRecord5> {
  return this.transport.invoke("kernel.v1.proposal.get", params) as Promise<ProposalRecord5>;
}
...
export async function proposalReject(
  this: KernelClient,
  params: ProposalDecisionParams,
): Promise<ProposalRecord6> {
  return this.transport.invoke("kernel.v1.proposal.reject", params) as Promise<ProposalRecord6>;
}
...
export async function sessionGet(
  ...
  return this.transport.invoke("kernel.v1.session.get", params) as Promise<SessionGetResult>;
}
