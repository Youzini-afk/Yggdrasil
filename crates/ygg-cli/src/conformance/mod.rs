...
fn build_cases() -> Vec<ConformanceCase> {
    ...
    vec![
        ...
        c!("outbound_websocket.secret_ref_undeclared_fails", ["outbound", "network", "websocket", "secret", "manifest"], network::outbound_websocket_secret_ref_undeclared_fails),
        c!("outbound_websocket.capability_namespace_enforced", ["outbound", "network", "websocket", "permission"], network::outbound_websocket_capability_namespace_enforced),
        c!("outbound_websocket.wss_only_default", ["outbound", "network", "websocket"], network::outbound_websocket_wss_only_default),
        c!("outbound_websocket.idle_timeout_emits_error_and_completed", ["outbound", "network", "websocket", "audit"], network::outbound_websocket_idle_timeout_emits_error_and_completed),
        c!("outbound_websocket.max_total_bytes_inbound_terminates", ["outbound", "network", "websocket", "audit"], network::outbound_websocket_max_total_bytes_inbound_terminates),
        ...
        c!("live_model.default_disabled_when_env_unset", ["live", "outbound", "network"], live_model::live_model_default_disabled_when_env_unset),
        c!("live_model.smoke_skipped_in_default_run", ["live", "outbound", "network"], live_model::live_model_smoke_skipped_in_default_run),
