...
- Contract V1 是公开平台规范，80 methods + 59 events + 8 top-level = 147 个 schema 全部通过校验，451 conformance cases 通过。
- 分层迁移已完成前三步：v1 事实漂移修复、Experimental Contract Registry / 显式协商，以及 36 条 owner-namespace canonical/legacy 双栈；后续按 [`CONTRACT_V2_MIGRATION.md`](CONTRACT_V2_MIGRATION.md) 建立 object/artifact 基础。
