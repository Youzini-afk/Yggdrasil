...
- 有 14 个顶层 schema；Phase 2 新增 `contract-selection.schema.json`，Phase 4 新增 `artifact-descriptor.schema.json`，Phase 5 新增 EffectReceipt 与四个 Change primitives schema。
