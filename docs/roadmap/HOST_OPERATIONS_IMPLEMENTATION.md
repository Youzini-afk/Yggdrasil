...
| Phase 4 | 进行中 | identity/observation 切片已实现 durable enrollment、独立 agent credential、heartbeat timeout、observe/revoke 与 epoch fencing；等待 CI 后继续 typed operation/driver/artifact/tunnel |
