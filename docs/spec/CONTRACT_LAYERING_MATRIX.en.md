...
- There are 14 top-level schemas. Phase 2 added `contract-selection.schema.json`, Phase 4 added `artifact-descriptor.schema.json`, and Phase 5 added EffectReceipt plus four Change primitive schemas.
