...
See [`docs/performance/PERFORMANCE_AND_CODE_HEALTH.md`](docs/performance/PERFORMANCE_AND_CODE_HEALTH.en.md) for the performance/code-health guide, [`docs/guides/EXTERNAL_PROJECT_OPERATING_PLANE.md`](docs/guides/EXTERNAL_PROJECT_OPERATING_PLANE.en.md) for the external-project operating-plane guide, [`docs/guides/STORAGE_BACKEND_NEUTRALITY.md`](docs/guides/STORAGE_BACKEND_NEUTRALITY.en.md) for the storage backend neutrality guide, [`docs/guides/POSTGRES_TDB_INTEGRATION.md`](docs/guides/POSTGRES_TDB_INTEGRATION.en.md) for the PostgreSQL + TDB integration guide, and [`docs/roadmap/NEXT_STEPS.md`](docs/roadmap/NEXT_STEPS.en.md) for the roadmap.
