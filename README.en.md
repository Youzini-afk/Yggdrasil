...
See [`docs/performance/PERFORMANCE_AND_CODE_HEALTH.md`](docs/performance/PERFORMANCE_AND_CODE_HEALTH.en.md) for the performance/code-health guide, [`docs/roadmap/EXTERNAL_PROJECT_OPERATING_PLANE_ALPHA.md`](docs/roadmap/EXTERNAL_PROJECT_OPERATING_PLANE_ALPHA.en.md) for the current external-project operating-plane plan, and [`docs/roadmap/NEXT_STEPS.md`](docs/roadmap/NEXT_STEPS.en.md) for the roadmap.
