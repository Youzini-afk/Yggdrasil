...
- Experience-Led Platform Beta：长期方向；长期设计见 [`docs/product/EXPERIENCE_LED_PLATFORM_BETA.md`](../product/EXPERIENCE_LED_PLATFORM_BETA.md)。Experience Beta 0–6、Performance & Code Health Beta、External Project Operating Plane Alpha、Storage Backend Neutrality Alpha 已完成。当前主线是 PostgreSQL + TDB Integration Alpha，临时计划见 [`docs/roadmap/POSTGRES_TDB_INTEGRATION_ALPHA.md`](./POSTGRES_TDB_INTEGRATION_ALPHA.md)。Storage 指南见 [`docs/guides/STORAGE_BACKEND_NEUTRALITY.md`](../guides/STORAGE_BACKEND_NEUTRALITY.md)。
