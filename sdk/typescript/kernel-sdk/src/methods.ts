...
export interface KernelMethods {
  ...
  outboundGitFetch(params: GitOutboundRequest): Promise<GitOutboundResponse>;
...
export async function outboundGitFetch(
  this: KernelClient,
  params: GitOutboundRequest,
): Promise<GitOutboundResponse> {
  return this.transport.invoke("kernel.v1.outbound.git_fetch", params) as Promise<GitOutboundResponse>;
}
...
export function attach<T extends KernelClient>(client: T): T & KernelMethods {
  ...
  (client as T & KernelMethods).outboundGitFetch = outboundGitFetch.bind(client);
